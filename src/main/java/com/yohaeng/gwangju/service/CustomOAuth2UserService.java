...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        switch (registrationId) {
            case "google":
                ...
                name = (String) attributes.get("name");  // 이름 처리
                break;
            ...
            case "kakao":
                ...
                name = (String) kakaoProfile.get("nickname");  // 카카오 이름 처리
                break;
            ...
            case "naver":
                ...
                name = (String) naverResponse.get("name");  // 네이버 이름 처리
                break;
        ...
        User user = saveOrUpdateUser(email, socialId, name, registrationId);  // 이름 포함
    ...
    private User saveOrUpdateUser(String email, String socialId, String name, String provider) {
        ...
        if (existingUser == null) {
            ...
            logger.debug("사용자 정보가 업데이트되었습니다: user_id={}", existingUser.getId());
            return existingUser;
        }
    }
}
