...
public class SecurityConfig {
        ...
        http
                ...
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers(
                                ...
                                "/mypage", "/food/**", "/map", "/map2", "/map3","/map4", "/check-email", "/main", "/"
                        )
                )
                // 권한 요청에 따른 접근 설정
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/gu", "/gu/data", "/{guName}/dongs", "/{guName}/dongs/data", "/districtOverlay",
                                "/food/**",
                                "/utils/dong", "/main", "/sidebarData", "/sidebarData2",
                                "/map", "/map2", "/map3","/map4","/map3all", "/mapSports", "/mapParking", "/geojson/**"
                        ).permitAll()
    ...
    private void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        // 인증 객체를 세션에 저장 (소셜 로그인과 자체 로그인 모두 적용)
